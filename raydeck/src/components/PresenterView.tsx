...
export function PresenterView({
  ...
  return (
    <main className="presenter-view" aria-label="Presenter view">
      {(error || saveState.status === 'error') && <div className="presenter-notices" tabIndex={0} aria-label="Presenter notices">
      ...
      <div className="presenter-grid">
        ...
        <aside className="presenter-sidebar" aria-label="Next slide and notes">
